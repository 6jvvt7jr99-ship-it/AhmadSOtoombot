...
bot.onText(/\/start/, (msg) => {
  ...
  const firstName = msg.from.first_name || 'أهلاً';

  userSessions[chatId] = {};

  bot.sendMessage(chatId,
    `👋 أهلاً ${firstName}!\n\nأنا البوت الرسمي لـ *أحمد العتوم* و *GOAI* 🚀\n\nسواء كنت تبحث عن تعلم التداول، تطوير مهاراتك المالية، أو الانضمام لمجتمع النجاح — أنت في المكان الصح.\n\nشو بتحب تعمل؟ 👇`,
    {
      parse_mode: 'Markdown',
      reply_markup: {
        inline_keyboard: [
          ...
          [{ text: '🎯 انضم للقناة مباشرة', url: 'https://t.me/startwithotoom' }]
        ]
      }
    }
  );
...
bot.on('callback_query', async (query) => {
  ...
  // --- Back to Start ---
  if (data === 'back_start') {
    const firstName = query.from.first_name || 'أهلاً';
    userSessions[chatId] = {};
    await bot.editMessageText(
      `👋 أهلاً ${firstName}!\n\nأنا البوت الرسمي لـ *أحمد العتوم* و *GOAI* 🚀\n\nسواء كنت تبحث عن تعلم التداول، تطوير مهاراتك المالية، أو الانضمام لمجتمع النجاح — أنت في المكان الصح.\n\nشو بتحب تعمل؟ 👇`,
      {
